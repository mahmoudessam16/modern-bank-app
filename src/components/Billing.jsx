        ...
        <section id='product' className={layout.sectionReverse}>
            ...
            <div className={layout.sectionInfo}>
                ...
                <div className='flex flex-row flex-wrap sm:mt-10 mt-6'>
                    <img src={apple} alt="apple" className='object-contain mr-5 cursor-pointer w-[128px] h-[42px]' />
                    <img src={google} alt="google__Play" className='cursor-pointer w-[128px] h-[42px ]' />
                </div>
            </div>
        </section>
    )
